...
\begin{itemize}
    ...
    \item Resized the EC2 fleet for FBA invoice services ahead of Black Friday by modeling the expected peak usage and the maximum requests each host could sustain on average, measured through load tests reflecting historical traffic distribution.
